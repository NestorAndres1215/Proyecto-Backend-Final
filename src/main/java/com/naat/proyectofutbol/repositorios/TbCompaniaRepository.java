...
public interface TbCompaniaRepository extends JpaRepository<TbCompania, String> {
	...
	List<Map<String, Object[]>> listaCompania(@Param("opcion") int opcion, @Param("com_codigo") String comCodigo,
			@Param("com_nombre") String comNombre, @Param("com_com_ruc") String comComRuc,
			@Param("com_telefono") String comTelefono, @Param("com_correo") String comCorreo,
			@Param("com_direccion") String comDireccion, @Param("com_pais") String comPais,
			@Param("com_sector") String comSector, @Param("com_fecha_de_fundacion") Date comFechaDeFundacion,
