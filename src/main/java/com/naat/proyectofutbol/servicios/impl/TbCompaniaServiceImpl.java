...
public class TbCompaniaServiceImpl implements TbCompaniaService {
	...
	public List<Map<String, Object[]>> listaCompania(int opcion, TbCompania obj) {
		return repository.listaCompania(opcion, obj.getCom_codigo(), obj.getCom_nombre(), obj.getCom_ruc(),
				obj.getCom_telefono(), obj.getCom_correo(), obj.getCom_direccion(), obj.getCom_pais(),
				obj.getCom_sector(), obj.getCom_fecha_de_fundacion(), obj.getCom_descripcion());
	}
